...
<div class="container">
    <div class="row">
        <div class="col s12 m12 l12 xl12 mt-20">
            <div class="card">
                <div>
                    ...
                    <form action="{{route('employees.store')}}" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="input-field col s12 m6 l6 xl4 offset-xl2">
                                ...
                                <span class="{{$errors->has('age') ? 'helper-text red-text' : ''}}">{{$errors->first('age')}}</span>
                            </div>
                            <div class="input-field col s12 m6 l6 xl4">
                            ...
                            <div class="input-field col s12 m6 l6 xl4">
                                ...
                                <select name="salary">
                                    ...
                                    @foreach($salaries as $salary)
                                        <option value="{{$salary->id}}" {{ old('salary') == $salary->id ? 'selected' : '' }}>${{$salary->s_amount}}</option>
                                    @endforeach
                                </select>
                                <label>Salary</label>
                            </div>
                            ...
                            <div class="file-field input-field col s12 m12 l12 xl8 offset-xl2">
                                ...
                                <div class="file-path-wrapper">
                                    ...
                                    <span class="{{$errors->has('picture') ? 'helper-text red-text' : ''}}">{{$errors->first('picture')}}</span>
                                </div>
                            </div>
                        </div>
                        @csrf()
